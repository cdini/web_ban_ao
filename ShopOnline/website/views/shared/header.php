...
<head>
    ...
    <meta charset="UTF-8">
    <title><?php echo isset($title) ? $title : 'Shop áo thể thao'; ?></title>
        ...
        <div class="header_top-sec">
            ...
            <div class="top_left">
                <form style="margin-bottom:0em " action="http://localhost/ShopOnline/search/" method="get"
                    ...
                    <input type=search name='q' id='q' value="Tìm kiếm..." onfocus="this.value = '';"
                    ...
                    <a href="dangnhap.php"><button type="button" class="btn btn-light">Đăng nhập</button></a>
                    <a href="#"><button type="button" class="btn btn-secondary">Đăng ký</button></a>
...
<div class="header-top">
    <div class="header-bottom">
        <div class="container">
            <div class="logo">
                <a href="index.php"><h1>Anh3B</h1></a>
            </div>
            <div class="top-nav">
                <ul class="memenu skyblue">
                    ...
                    <?php foreach ($parent_menus as $parent_menu): $parentId = $parent_menu['Id']; ?>
                        ...
                        <?php endif; ?>
                    <?php endforeach; ?>
                    <li><a href="livesport">Thanh viên nhóm</a></li>
                </ul>
            </div>
            <div class="cart box_1">
                <a href="cart"><i class="glyphicon glyphicon-shopping-cart"></i> Giỏ hàng : <?php echo cart_number(); ?> sản phẩm</a>
                <div class="clearfix"></div>
            </div>
        </div>
    </div>
